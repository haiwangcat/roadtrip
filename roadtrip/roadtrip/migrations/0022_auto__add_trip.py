...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Trip'
        db.create_table(u'roadtrip_trip', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poi_list', self.gf('django.db.models.fields.CharField')(max_length=10000)),
            ('trip_name', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal(u'roadtrip', ['Trip'])


    def backwards(self, orm):
        # Deleting model 'Trip'
        db.delete_table(u'roadtrip_trip')
    ...
    models = {
        ...
        u'roadtrip.trip': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'poi_list': ('django.db.models.fields.CharField', [], {'max_length': '10000'}),
