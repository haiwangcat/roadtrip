...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field pois on 'Trip'
        m2m_table_name = db.shorten_name(u'roadtrip_trip_pois')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trip', models.ForeignKey(orm[u'roadtrip.trip'], null=False)),
            ('poi', models.ForeignKey(orm[u'roadtrip.poi'], null=False))
        ))
        db.create_unique(m2m_table_name, ['trip_id', 'poi_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field pois on 'Trip'
        db.delete_table(db.shorten_name(u'roadtrip_trip_pois'))
    ...
    models = {
        ...
        u'roadtrip.trip': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pois': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['roadtrip.POI']", 'symmetrical': 'False'}),
