...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'POI.street_address'
        db.add_column(u'roadtrip_poi', 'street_address',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'POI.street_address'
        db.delete_column(u'roadtrip_poi', 'street_address')
