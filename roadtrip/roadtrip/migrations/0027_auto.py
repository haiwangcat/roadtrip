...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding SortedM2M table for field pois on 'Trip'
        db.create_table(u'roadtrip_trip_pois', (
        ...
        db.create_unique(u'roadtrip_trip_pois', ['trip_id', 'poi_id'])
    ...
    models = {
        ...
        u'roadtrip.trip': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pois': ('sortedm2m.fields.SortedManyToManyField', [], {'to': u"orm['roadtrip.POI']", 'symmetrical': 'False'}),
