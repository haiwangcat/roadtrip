...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'POI.avg_ratings'
        db.add_column(u'roadtrip_poi', 'avg_ratings',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'POI.avg_ratings'
        db.delete_column(u'roadtrip_poi', 'avg_ratings')
    ...
    models = {
        ...
        u'roadtrip.poi': {
            ...
            'avg_ratings': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
