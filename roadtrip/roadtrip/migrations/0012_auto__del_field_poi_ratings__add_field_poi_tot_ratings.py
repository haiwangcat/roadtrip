...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'POI.ratings'
        db.delete_column(u'roadtrip_poi', 'ratings')

        # Adding field 'POI.tot_ratings'
        db.add_column(u'roadtrip_poi', 'tot_ratings',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'POI.ratings'
        db.add_column(u'roadtrip_poi', 'ratings',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'POI.tot_ratings'
        db.delete_column(u'roadtrip_poi', 'tot_ratings')
    ...
    models = {
        ...
        u'roadtrip.poi': {
            ...
            'tot_ratings': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
