...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.waypoint_id'
        db.add_column(u'roadtrip_trip', 'waypoint_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.waypoint_id'
        db.delete_column(u'roadtrip_trip', 'waypoint_id')
    ...
    models = {
        ...
        u'roadtrip.trip': {
            ...
            'waypoint_id': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        }
    }
